# App Trader
App Trader is a new company that requires assistance exploring and gaining insights from apps made available through the App Store and Android Play Store.
...
Based on research completed prior to launching App Trader as a company, we assume the following:  
